...
public class deleteReceptionist extends JFrame 
{
	int count,age;
	...
	{
	super("Delete Receptionist Information");
        initComponents();
	...
	mLabel.setAlignment(Label.CENTER);
        ...
        mLabel.setForeground(new Color(255, 255, 255));
       	mLabel.setText("Delete Receptionist");
