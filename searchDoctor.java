...
public class searchDoctor extends JFrame 
{
	...
	public searchDoctor()
	{
	super("Search Doctor Information");
        initComponents();
	...
	String searchKey = sea.getText();
        String sql = "select count,date,id,name,age,gender,dept,phone,email,status,address,room,username,password from doctor where name= '"+searchKey+"'";
        try {
